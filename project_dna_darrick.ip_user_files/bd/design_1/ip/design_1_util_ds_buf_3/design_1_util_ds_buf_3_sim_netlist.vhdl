...
-- Date        : Thu Jul 11 11:25:34 2019
-- Host        : msi running 64-bit Ubuntu 16.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_util_ds_buf_3 -prefix
--               design_1_util_ds_buf_3_ design_1_util_ds_buf_1_sim_netlist.vhdl
...
entity design_1_util_ds_buf_3_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_1_util_ds_buf_3_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_1_util_ds_buf_3_util_ds_buf : entity is "ibufdsgte4";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_1_util_ds_buf_3_util_ds_buf : entity is 1;
end design_1_util_ds_buf_3_util_ds_buf;

architecture STRUCTURE of design_1_util_ds_buf_3_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_util_ds_buf_3 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of design_1_util_ds_buf_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_util_ds_buf_3 : entity is "design_1_util_ds_buf_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_util_ds_buf_3 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_util_ds_buf_3 : entity is "util_ds_buf,Vivado 2018.3";
end design_1_util_ds_buf_3;

architecture STRUCTURE of design_1_util_ds_buf_3 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, CLK_DOMAIN design_1_util_ds_buf_1_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, CLK_DOMAIN design_1_util_ds_buf_1_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.design_1_util_ds_buf_3_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
