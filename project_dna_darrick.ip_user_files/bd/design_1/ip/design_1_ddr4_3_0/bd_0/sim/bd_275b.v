...
//--------------------------------------------------------------------------------
//Command: generate_target bd_275b.bd
//Design : bd_275b
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_275b,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_275b,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_ddr4_3_0_microblaze_mcs.hwdef" *) 
module bd_275b
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_275b lmb_bram_I bd_275b second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_275b_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_275b_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_275b_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_275b_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_275b dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_275b_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_275b_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_275b_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_275b_second_lmb_bram_I_0 second_lmb_bram_I
